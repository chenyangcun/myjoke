...
public class OAuth {
	private String oauth_consumer_key = "801134623";// AppKey(client credentials)	
	private String oauth_consumer_secret = "e670bcf12eb063fc5aedb232213b69bf";// 签名密钥1
	...
	public List<QParameter> getTokenParams() {
		...
		parameters.add(new QParameter("oauth_timestamp", oauth_timestamp));
		parameters.add(new QParameter("oauth_nonce", oauth_nonce));
		parameters.add(new QParameter("oauth_token",this.getOauth_token()));
		parameters.add(new QParameter("oauth_version", oauth_version));			
		return parameters;
	}
